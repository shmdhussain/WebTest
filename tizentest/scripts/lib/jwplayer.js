...
window.jwplayer = (function (t) {
	...
	function (t, e, n) {
		...
		e.b = function (t) {
			...
			try {
				...
				if (
					('pro' === (e = s[0]) && (e = 'premium'), Object(i.a)(e)('setup') || (e = 'invalid'), s.length > 2)
				) {
					n = s[1];
					var l = parseInt(s[2]);
	...
	function (t, e, n) {
		...
		var u = function (t) {
				if (t && t.file) {
					...
					return (
						(n.kind = ((e = n.kind), -1 !== o.indexOf(e) ? n.kind : 'captions')),
						(n.default = !!n.default),
						n
					);
				}
			...
			s = function (t, e) {
				...
				if (o.length) {
					...
					for (var d = 0; d < o.length; d++) {
						var p = o[d];
						p.file.length > 0 &&
							((p[n] = 'true' === o[d][n]), p.label || delete p.label, a.sources.push(p));
					}
				}
				if (u.length) {
					e.tracks = [];
	...
	function (t, e, n) {
		...
		e.b = function (t, e) {
			...
			(!v.playbackRateControls || v.playbackRates.indexOf(v.defaultPlaybackRate) < 0) &&
				...
				if (
					...
					Object(r.x)(i) &&
						...
						((j.playlist = (function (t, e) {
							...
							return (
								o && (i += '&page_description=' + encodeURIComponent(o)), e.replace('__CONTEXTUAL__', i)
							);
						})(document, j.playlist)),
						(j.contextual = !0)),
								...
								(function (t, e, n) {
									Promise.resolve().then(function () {
										...
										if (!o) {
											...
											it.a.cloneIcon &&
												u.querySelector('.jw-icon').appendChild(it.a.cloneIcon('error')),
												ft(t, u);
										}
										i.set('errorEvent', r),
											i.set('state', I.lb),
	...
	function (t, e, n) {
		...
		function r() {
			...
			if (window.top !== window.self) {
				n = (
					document.referrer ? ((t = document.referrer), ((e = document.createElement('a')).href = t), e) : {}
				).host;
				try {
